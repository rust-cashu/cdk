...
impl VerifyingKey {
    ...
    pub fn from_public_key(public_key: &PublicKey) -> Result<Self, Error> {
        let bytes = public_key.inner.to_sec1_bytes();
        ...
        VerifyingKey::from_bytes(&bytes).map_err(|_| crate::prelude::Error::Key)
    }
