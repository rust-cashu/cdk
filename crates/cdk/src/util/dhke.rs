...
#[cfg(feature = "mint")]
pub use self::mint::{sign_message, verify_message};
#[cfg(feature = "wallet")]
pub use self::wallet::{blind_message, construct_proofs, unblind_message};
...
pub fn hash_e<I>(public_keys: I) -> Vec<u8>
where
    I: IntoIterator<Item = PublicKey>,
{
    ...
    for public_key in public_keys.into_iter() {
        let uncompressed_point = public_key.to_encoded_point(false).to_bytes();
